...
locals {
  ...
  resource_name_prefix_dashless = replace(local.resource_name_prefix, "-", "")
  ...
  key_vault_name                = "${local.resource_name_prefix_dashless}kvtmp"
  storage_account_name          = "${local.resource_name_prefix_dashless}strtmp"
}
